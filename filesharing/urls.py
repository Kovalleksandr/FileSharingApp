...
from .views import ClientCollectionView, PhotoUploadView, CollectionCreateView, CollectionView, GenerateClientLinkView, PhotoDeleteView, CollectionDeleteView
